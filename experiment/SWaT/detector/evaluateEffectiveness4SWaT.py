...
def evaluateEffectiveness4SWaT():
    ...
    for file in evalNegativeTracefiles:
        ...
        for n in range(1, maxstep):
            ...
            for i in range(0, intervalNum):
                ...
                mvRes = evalNegativeTraceLines[lineNum*intervalNum*(n-1)+lineNum*i+1].strip().split(",")
                MV101 = int(mvRes[0])
                MV201 = int(mvRes[1])
                MV301 = int(mvRes[2])
                MV302 = int(mvRes[3])
                ...
                pumpRes = evalNegativeTraceLines[lineNum*intervalNum*(n-1)+lineNum*i+3].strip().split(",")
                P101 = int(pumpRes[0])
                P102 = int(pumpRes[1])
                P301 = int(pumpRes[2])
                P302 = int(pumpRes[3])
            ...
            yRes_old = evalNegativeTraceLines[lineNum*intervalNum*(n-1)].strip().split(",")
            yRes = evalNegativeTraceLines[lineNum*intervalNum*n].strip().split(",")
            for i in range(0, 3):
    ...
    for file in evalPositiveTracefiles:
        ...
        for n in range(1, maxstep):
            ...
            for i in range(0, intervalNum):
                # MV101,MV201,MV301,MV302,MV303,MV304,MV501,MV502,MV503,MV504
                mvRes = evalPositiveTraceLines[lineNum*intervalNum*(n-1)+lineNum*i+2].strip().split(",")
                MV101 = int(mvRes[0])
                MV201 = int(mvRes[1])
                MV301 = int(mvRes[2])
                MV302 = int(mvRes[3])
                ...
                # P101,P102,P301,P302,P401,P402,P501,P502,P601,P602
                pumpRes = evalPositiveTraceLines[lineNum*intervalNum*(n-1)+lineNum*i+4].strip().split(",")
                P101 = int(pumpRes[0])
                P102 = int(pumpRes[1])
                P301 = int(pumpRes[2])
                P302 = int(pumpRes[3])
            ...
            # YS101(k),YS301(k),YS401(k)
            yRes_old = evalPositiveTraceLines[lineNum*intervalNum*(n-1)+1].strip().split(",")
            yRes = evalPositiveTraceLines[lineNum*intervalNum*n+1].strip().split(",")
            for i in range(0, 3):
                YS[i] = float(yRes[i]) - float(yRes_old[i])
