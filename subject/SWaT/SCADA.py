...
class H:
	def __init__(self):
		...
		self.AIT201 = HMI_ait(950.0,260.0,250.0,50.0)           # Conductivity (µS/cm) (NaCl)
		self.AIT202 = HMI_ait(12.0,7.05,6.95,3.0)               # pH (HCl)
		self.AIT203 = HMI_ait(750.0,500.0,420.0,100.0)          # Oxidation Reduction Potential (mV) (NaOCl)
		# self.P3
		...
		self.PSH301 = HMI_PSH()                                 # Pressure switch (High)
		self.DPSH301 = HMI_DPSH()                               # Differential pressure switch (High)
		self.DPIT301 = HMI_DPIT(101.325,40.53,10.1325,0.0)      # Differential pressure indicating transmitter
		self.MV301 = HMI_mv()
		self.MV302 = HMI_mv()
		self.MV303 = HMI_mv()
		self.MV304 = HMI_mv()
		...
		self.FIT501 = HMI_FIT(4.0,2.0,1.0,0.0)
		self.FIT502 = HMI_FIT(4.0,1.3,1.1,0.0)
		self.FIT503 = HMI_FIT(4.0,0.9,0.7,0.0)
		self.FIT504 = HMI_FIT(2.0,0.35,0.25,0.0)
		self.MV501 = HMI_mv()
		self.MV502 = HMI_mv()
		self.MV503 = HMI_mv()
		self.MV504 = HMI_mv()
		...
		self.P602 = HMI_pump()
		self.P603 = HMI_pump()
		self.FIT601 = HMI_FIT(4.0,3.0,2.0,0.0)