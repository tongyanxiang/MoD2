...
class plc6:
	...
	def __init__(self,HMI):
		...
		self.P601_FB = PMP_FBD(HMI.P601)
		self.P602_FB = PMP_FBD(HMI.P602)
		self.P603_FB = PMP_FBD(HMI.P603)
...
# Main
		...
		if HMI.P6.State == 1:
			...
			self.Mid_P_PERMEATE_SR = SETD(HMI.LSH601.Alarm and HMI.AIT202.Pv >= 7 and not HMI.LIT101.AHH and 0,
										  HMI.LIT101.AHH or HMI.LSL601.Alarm or HMI.AIT202.Pv < 7,
										  self.Mid_P_PERMEATE_SR)
		...
		self.P601_FB.PMP_FBD(self.Mid_P601_AutoInp, IO.P601, HMI.P601)
		self.P602_FB.PMP_FBD(self.Mid_P602_AutoInp, IO.P602, HMI.P602)
		self.P603_FB.PMP_FBD(self.Mid_P603_AutoInp, IO.P603, HMI.P603)