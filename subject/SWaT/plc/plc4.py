...
class plc4:
	...
	def __init__(self,HMI):
		...
		self.Mid_P_RO_FEED_DUTY_AutoInp = HMI.P401.Status-1      # P401 or P402
		self.Mid_P_NAHSO3_ORP_DUTY_AutoInp = HMI.P403.Status-1   # P403 or P404
	...
	def Pre_Main_RO_Feed_Dosing(self, IO, HMI):
		...
		self.Mid_FIT401_Tot_Enb	= HMI.P401.Status==2 or HMI.P402.Status==2 # P401 or P402 starts => FIT401 can be enable
		...
		HMI.P401.SD[1] = HMI.P401.Status==2 and HMI.MV501.Status!=2 and HMI.MV502.Status!=2 and HMI.MV503.Status!=2 and HMI.MV504.Status!=2
		...
		HMI.P402.SD[1] = HMI.P402.Status==2 and HMI.MV501.Status!=2 and HMI.MV502.Status!=2 and HMI.MV503.Status!=2 and HMI.MV504.Status!=2
...
# Main
		...
		if HMI.P4.State == 4:
			...
			self.Mid_P_NAHSO3_ORP_DUTY_AutoInp = SETD((HMI.P401.Status==2 or HMI.P402.Status==2) and (HMI.AIT402.AH),
													  (HMI.P401.Status!=2 and HMI.P402.Status!=2) or (HMI.AIT402.AL),
													  self.Mid_P_NAHSO3_ORP_DUTY_AutoInp)

			#print("P4.State: {}".format(HMI.P4.State))
			if HMI.Cy_P5.RO_HPP_SD_On: # RO_HPP_SD_On=0
				HMI.P4.State = 5
