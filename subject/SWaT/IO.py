...
class P2:
	def __init__(self):
		# P2
		self.LS201  = IO_SWITCH()      # Level switch
		self.LS202  = IO_SWITCH()      # Level switch
		self.LSL203  = IO_SWITCH()     # Level switch (Low)
		self.LSLL203  = IO_SWITCH()    # Level switch (Low Low)
		self.MV201  = IO_MV()
		self.P201   = IO_PMP_UV()
		self.P202   = IO_PMP_UV()
		self.P203   = IO_PMP_UV()
		...
		self.AIT201 = IO_AIN_FIT()     # Conductivity (µS/cm) (NaCl)
		self.AIT202 = IO_AIN_FIT()     # pH (HCl)
		self.AIT203 = IO_AIN_FIT()     # Oxidation Reduction Potential (mV) (NaOCl)
...
class P3:
	def __init__(self):
		...
		self.P301   = IO_PMP_UV()
		self.P302   = IO_PMP_UV()
		self.PSH301 = IO_SWITCH()     # Pressure switch (High)
		self.DPSH301= IO_SWITCH()     # Differential pressure switch (High)
		self.DPIT301= IO_AIN_FIT()    # Differential pressure indicating transmitter
		self.MV301  = IO_MV()
		self.MV302  = IO_MV()
		self.MV303  = IO_MV()
		self.MV304  = IO_MV()
